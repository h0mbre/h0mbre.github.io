...
My goal for this assignment since we had just leanred how to hook syscalls in the previous assignment, was to create a userland rootkit that utilized a well-represented service (I went with SSH) to provide either a bind or reverse shell, 
