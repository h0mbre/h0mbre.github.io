...
We'll need to add both the egg hunter shellcode and our bind TCP shell shellcode to our shellcode.c program and test it. Don't forget to prepend your egg to your payload twice. 
